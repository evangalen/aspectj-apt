...
import org.aspectj.com.sun.mirror.declaration.FieldDeclaration;
    	...
    	for( int i=0, len=bodyDecls.size(); i<len; i++ ){
    		...
    		if( bodyDecl.getNodeType() == ASTNode.FIELD_DECLARATION ){
    			final List<VariableDeclarationFragment> fragments =
                    ((org.aspectj.org.eclipse.jdt.core.dom.FieldDeclaration)bodyDecl).fragments();
    	...
    	for( int i=0, len=bodyDecls.size(); i<len; i++ ){
    		...
    		case ASTNode.METHOD_DECLARATION:
    			final org.aspectj.org.eclipse.jdt.core.dom.MethodDeclaration methodDecl = 
    					(org.aspectj.org.eclipse.jdt.core.dom.MethodDeclaration)bodyDecl;    			
