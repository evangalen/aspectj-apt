...
import org.aspectj.com.sun.mirror.declaration.AnnotationTypeElementDeclaration;
...
public class AnnotationMirrorImpl implements AnnotationMirror, EclipseMirrorObject
{
    ...
    public SourcePosition getPosition()
    {
		if( isFromSource() ){
			...
			final org.aspectj.org.eclipse.jdt.core.dom.Annotation annotation = getAstNode();
			if( annotation == null ) return null;
			org.aspectj.org.eclipse.jdt.core.dom.ASTNode astNode = annotation.getTypeName();
			if( astNode == null )
				astNode = annotation;
    ...
    org.aspectj.org.eclipse.jdt.core.dom.Annotation getAstNode()
	{ 
		if( isFromSource() ){
			final CompilationUnit unit = _annotated.getCompilationUnit();
			final ASTNode node = unit.findDeclaringNode(_domAnnotation);
			if( node instanceof org.aspectj.org.eclipse.jdt.core.dom.Annotation )
				return (org.aspectj.org.eclipse.jdt.core.dom.Annotation)node;			
		}	
		return null;
    }
	...
	ASTNode getASTNodeForElement(String name)
	{
		...
		final org.aspectj.org.eclipse.jdt.core.dom.Annotation anno = getAstNode();
		if( anno != null ){
