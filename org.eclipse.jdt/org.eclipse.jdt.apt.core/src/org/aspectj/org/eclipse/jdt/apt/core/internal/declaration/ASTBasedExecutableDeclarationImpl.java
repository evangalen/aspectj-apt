...
public abstract class ASTBasedExecutableDeclarationImpl 
    ...
    {
    	final org.aspectj.org.eclipse.jdt.core.dom.MethodDeclaration methodAstNode = getMethodAstNode(); 
    	final SimpleName nameNode = methodAstNode.getName();
    	return nameNode == null ? EMPTY_STRING : nameNode.getIdentifier();
    }
    
    org.aspectj.org.eclipse.jdt.core.dom.MethodDeclaration getMethodAstNode(){ 
		return (org.aspectj.org.eclipse.jdt.core.dom.MethodDeclaration)_astNode; 
	}
